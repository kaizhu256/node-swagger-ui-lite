...
// https://github.com/louischatriot/nedb/blob/v1.4.2/lib/storage.js
// utility2-uglifyjs https://raw.githubusercontent.com/louischatriot/nedb/v1.4.2/lib/storage.js
var fs=require("fs"),mkdirp=require("mkdirp"),async=require("async"),storage={};storage.exists=fs.exists,storage.rename=fs.rename,storage.writeFile=fs.writeFile,storage.unlink=fs.unlink,storage.appendFile=fs.appendFile,storage.readFile=fs.readFile,storage.mkdirp=
mkdirp,storage.ensureFileDoesntExist=function(e,t){storage.exists(e,function(n){if(!n)return t(null);storage.unlink(e,function(e){return t(e)})})},storage.flushToStorage=function(e,t){if(process.platform==="win32"||process.platform==="win64")return t();fs.open
(e,"r",function(e,n){if(e)return t(e);fs.fsync(n,function(e){return t(e)})})},storage.crashSafeWriteFile=function(e,t,n){var r=n||function(){},i=e+"~",s=e+"~~";async.waterfall([async.apply(storage.ensureFileDoesntExist,i),async.apply(storage.ensureFileDoesntExist
,s),function(t){storage.exists(e,function(n){if(!n)return t();storage.rename(e,s,function(e){if(e)return t(e);storage.flushToStorage(s,t)})})},function(e){storage.writeFile(i,t,function(t){return e(t)})},function(t){storage.rename(i,e,function(e){return t(e
)})},async.apply(storage.flushToStorage,e),async.apply(storage.ensureFileDoesntExist,s)],function(e){return r(e)})},storage.ensureDatafileIntegrity=function(e,t){var n=e+"~",r=e+"~~";storage.exists(e,function(n){if(n)return t(null);storage.exists(r,function(
n){if(!n)return storage.writeFile(e,"","utf8",function(e){t(e)});storage.rename(r,e,function(e){return t(e)})})})},module.exports=storage
/* jslint-ignore-end */
...
/* jslint-ignore-begin */
// init lib nedb
// replace 'i=t("./storage")' with 'i=local.storage||t("./storage")'
// https://github.com/louischatriot/nedb/blob/v1.4.2/browser-version/out/nedb.min.js
        ...
        local.require = function (module) {
            ...
            case 'mkdirp':
                return function (dir, onError) {
                    local.fs.exists(dir, function (exists) {
                        if (!exists) {
                            try {
